...
service('formPatterns', [function() {
    ...
    // Used on cart
    // self.PHONE_REGEXP = /^0[6-7]{1}[0-9]{8}$/;
    // self.FAI_REGEXP = /^0[123459]{1}[0-9]{8}$/;
    // self.RIO_REGEXP = /^[a-z0-9+]{12}$/i;
    // self.ALPHANUM_REGEXP = /^[a-zA-Z0-9]{12}$/i;
    ...
    self.PHONE_REGEXP = /^0[1-9]{1}[0-9]{8}$/;
